...
public class QuickstepLauncher extends BaseQuickstepLauncher {
    ...
    public static final String TAG = "QuickstepLauncher";
    ...
    private void CheckUpdate() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) { 
            String incrimental = SystemProperties.get("ro.build.version.incremental", "0");
            String incrimentalUP ="OS."+SystemProperties.get("ro.build.version.incremental", "0")+".zip";
            String currenversion = android.provider.Settings.Global.getString(getApplicationContext().getContentResolver(),	android.provider.Settings.Global.USER_STRING_DATA_THR);
            if (!currenversion.equals(null) && !currenversion.equals("0")  && !currenversion.equals(incrimentalUP) ) {
